...
def main():
    ...
    st.write("A simple and classic interface for **Live Recognition, Image Recognition, and Accuracy Plot**")

    menu = st.sidebar.radio(
        "Navigation",
        ["🏠 Home", "📹 Live Recognition", "🖼️ Image Recognition", "📊 Accuracy Plot"]
    )
    ...
    if menu == "🏠 Home":
        ...
        st.write(
            ...
            "upload an image for recognition, and view model accuracy."
        )
    ...
    # Accuracy Plot
    # -------------------------------
    elif menu == "📊 Accuracy Plot":
        st.subheader("Model Accuracy")
        if os.path.exists("accuracy_plot.png"):
            st.image("accuracy_plot.png", caption="Accuracy vs Epochs", use_container_width=True)
        else:
